...
BEGIN
    FOR i IN 0..80 LOOP
		partition_start := i::bigint * 10000000000::bigint;
		partition_end   := (i::bigint + 1::bigint) * 10000000000::bigint;
...
CREATE INDEX idx_transactions_block ON transactions((id / 10000));
CREATE INDEX idx_transfers_block ON transfers((transaction / 10000));
